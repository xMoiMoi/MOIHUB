...
@flask_login.login_required
def dashboard():
    code_files = list(srp.load_all(CodeFile))  # Cargar todos los archivos de código
    return flask.render_template("dashboard.html", code_files=code_files, srp=srp)  # Pasar los archivos de código al contexto
